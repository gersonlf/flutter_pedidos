...
procedure atualizarItemListViewAdicional(AItem: TListViewItem;
  AInserindo: boolean);
...
begin
  ...
  begin
    ...
    begin
      if AInserindo then
        Text := DM.mtAdicionais.FieldByName('descricao_produto').AsString;
      Align := TListItemAlign.Leading;
      TextAlign := TTextAlign.Leading;
    ...
    begin
      if AInserindo then
        Text := DM.mtAdicionais.FieldByName('codigo_produto').AsString;
      Align := TListItemAlign.Leading;
      TextAlign := TTextAlign.Leading;
      TextVertAlign := TTextAlign.Leading;
      TextColor := $FF27408B;
    ...
    with txt do
    begin
      if AInserindo and (DM.mtAdicionais.FieldByName('codigo_barra').AsString <>
        '0000000000000') then
        Text := DM.mtAdicionais.FieldByName('codigo_barra').AsString;
      Align := TListItemAlign.Trailing;
      TextAlign := TTextAlign.Trailing;
      TextVertAlign := TTextAlign.Leading;
      TextColor := $FF27408B;
    ...
    with txt do
    begin
      if AInserindo and (DM.mtAdicionais.FieldByName('codigo_reduzido')
        .AsInteger > 0) then
        Text := DM.mtAdicionais.FieldByName('codigo_reduzido').AsString;
      Align := TListItemAlign.Center;
      TextAlign := TTextAlign.Center;
      TextVertAlign := TTextAlign.Leading;
      TextColor := $FF27408B;
    ...
    begin
      if AInserindo then
        Text := formataFloatStr2
          (DM.mtAdicionais.FieldByName('valor_unitario').AsFloat);
      Align := TListItemAlign.Leading;
      TextAlign := TTextAlign.Leading;
      TextVertAlign := TTextAlign.Leading;
      TextColor := $FFFF3030;
    ...
    begin
      if AInserindo then
        Text := DM.mtAdicionais.FieldByName('unidade_produto').AsString;;
      Align := TListItemAlign.Trailing;
      TextAlign := TTextAlign.Trailing;
      TextVertAlign := TTextAlign.Leading;
      TextColor := $FF27408B;
