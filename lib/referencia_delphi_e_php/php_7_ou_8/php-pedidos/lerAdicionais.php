<?php
    ...
    validarConexao($mysqli);
        ...
        */
        ...
        $qr .= ' if(COALESCE(a.preco_venda, 0) = 0,if(isnull(c.preco_vendaV),0,c.preco_vendaV),a.preco_venda) valor_unitario,';
        ...
        $qr .= ' where a.tipo_composicao=3 AND ISNULL(a.data_exc) ';
        ...
        if (!$mysql) {
            responderErro('Erro executando query em lerAdicionais.php: ' . $mysqli->error);
        }
